...
```
 core.basesyntax.Figure: square, area: 25 sq. units, side length: 5 units, color: blue
 core.basesyntax.Figure: triangle, area: 12.5 sq. units, hypotenuse: 7.1 units, color: yellow
```
