...
public class FigureSupplier {
    ...
    public Figure getRandomFigure() {
        ...
        switch (value) {
            ...
            case 1:
                return new Rectangle(colorSupplier.getRandomColor(), randomParameter,
                  randomParameter);
            case 2:
                return new Circle(colorSupplier.getRandomColor(), randomParameter);
            case 3:
                return new IsoscelesTrapezoid(colorSupplier.getRandomColor(), randomParameter,
                  randomParameter);
            default:
                return new RightTriangle(colorSupplier.getRandomColor(), randomParameter,
                  randomParameter);
        }
    }
