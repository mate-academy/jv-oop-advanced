...
public class FigureSupplier {
    ...
    public Figure getRandomFigure() {
        ...
        switch (randomFigure) {
            ...
            case 3:
                return new RightTriangle(generateNumber(FIGURE_BOUNDARY),
                        generateNumber(FIGURE_BOUNDARY), color.getRandomColor());
            case 4:
                return new Rectangle(generateNumber(FIGURE_BOUNDARY),
                        generateNumber(FIGURE_BOUNDARY), color.getRandomColor());
            case 5:
                return new IsoscelesTrapezoid(generateNumber(FIGURE_BOUNDARY),
                        generateNumber(FIGURE_BOUNDARY), generateNumber(FIGURE_BOUNDARY),
