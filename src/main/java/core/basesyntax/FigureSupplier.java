...
public class FigureSupplier {
    ...
    public static Figure getRandomFigure() {
        int figureChoice = 1 + (int)(Math.random() * FIGURE_COUNT);
        ...
        switch (figureChoice) {
            case 1:
                return new IsoscelesTrapezoid(ColorSupplier.getRandomColor(), dimension1,
            ...
            default:
                System.out.println("Something wrong with figure number randomizer, "
                        + "you'll get default figure");
