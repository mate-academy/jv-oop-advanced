...
public class FigureSupplier {
    ...
    public Figure randomFigure() {
        ...
        switch (randomNumber) {
            ...
            case 3:
                return new RightTriangle(ColorSuplier.randomColor(), new Random().nextInt(RAND_NUMBER));
            case 4:
                return new IsoscelesTrapezoi(ColorSuplier.randomColor(), new Random().nextInt(RAND_NUMBER),
                        new Random().nextInt(RAND_NUMBER));
            default:
