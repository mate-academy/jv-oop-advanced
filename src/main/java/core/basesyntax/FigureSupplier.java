...
public class FigureSupplier {
    ...
    public Figure getRandomFigure() {
        ...
        switch (figureNumber) {
            ...
            case 1: return new Rectangle(random.nextInt(SIDE_LENGTH),
                    random.nextInt(SIDE_LENGTH), colorSupplier.getRandomColor());
            case 2: return new RightTriangle(random.nextInt(SIDE_LENGTH),
                    random.nextInt(SIDE_LENGTH),
                    colorSupplier.getRandomColor());
            case 3: return new IsoscelesTrapezoid(random.nextInt(SIDE_LENGTH),
                    random.nextInt(SIDE_LENGTH),
                    random.nextInt(SIDE_LENGTH), colorSupplier.getRandomColor());
