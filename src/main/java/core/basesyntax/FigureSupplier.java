...
public class FigureSupplier {
    ...
    private Square square = new Square(colorSupplier.getRandomColor(),
    ...
    private RightTriangle rightTriangle = new RightTriangle(colorSupplier.getRandomColor(),
            randomFigure.nextInt(100), randomFigure.nextInt(100));
    private Circle circle = new Circle(colorSupplier.getRandomColor(),
            randomFigure.nextInt(100));
    private IsoscelesTrapezoid isoscelesTrapezoid =
            new IsoscelesTrapezoid(colorSupplier.getRandomColor(),
            randomFigure.nextInt(100), randomFigure.nextInt(100),
                    randomFigure.nextInt(100));
    private Figure[] array = new Figure[]{square, rectangle,
