...
public class FigureSupplier {
    public Figure getRandomFigure() {
        ...
        switch (new Random().nextInt(5)) {
            ...
            case 3 :
                return new RightTriangle(new Random().nextDouble() * 10, new Random().nextDouble() * 10, color);
            case 4:
                return new IsoscelesTrapezoid(new Random().nextDouble() * 10, new Random().nextDouble() * 10, new Random().nextDouble() * 10, color);
            default:
                return null;
        }
    }
