...
public class FigureSupplier {
        public static final String[] FIGURES = new String[] {"Square", "Rectangle", "Circle", "Right Triangle", "Isosceles Trapezoid"};
        ...
        public Figure getRandomFigure() {
            ...
            switch (chooseFigure) {
                ...
                case 2: return new Rectangle(randomNumber1, randomNumber2, colorSupplier.getRandomColor());
                case 3: return new Circle(randomNumber1, colorSupplier.getRandomColor());
                case 4: return new RightTriangle(randomNumber1, randomNumber2, colorSupplier.getRandomColor());
                default: return new IsoscelesTrapezoid(randomNumber1, randomNumber2, randomNumber3, colorSupplier.getRandomColor());
            }
        }
}
