...
public class FigureSupplier{
    ...
    public Figure getRandomFigure(){
        ...
        Figure[] figures = {new IsoscelesTrapezoid(colorSupplier.getRandomColor(),random.nextInt(), random.nextInt(),random.nextInt()),
                new Circle(colorSupplier.getRandomColor(), random.nextInt()),
