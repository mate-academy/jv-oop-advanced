...
public class FigureSupplier {
    ...
    private static final Circle defaultCircle = new Circle(10, Colors.WHITE.name());
    ...
    public Figure getRandomFigure() {
        return switch (random.nextInt(MAX_FIGURE_ID)) {
            ...
            case 1 -> new Rectangle(random.nextDouble(MAX_SIZE), random.nextDouble(MAX_SIZE),
                    colorSupplier.getRandomColor());
            case 2 -> new RightTriangle(random.nextDouble(MAX_SIZE), random.nextDouble(MAX_SIZE),
                    colorSupplier.getRandomColor());
            ...
            case 4 -> new IsoscelesTrapezoid(
                    ...
                    random.nextDouble(MAX_SIZE), colorSupplier.getRandomColor());
