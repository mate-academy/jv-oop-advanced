    ...
    public Figure getRandomFigure() {
        ...
        switch (index) {
            ...
            case 2:
                ...
                return rectangle;
            case 3:
                int sideD = new Random().nextInt(10);
                int heigthD = new Random().nextInt(10);
            ...
            case 4:
                int firstLegE = new Random().nextInt(10);
                int secondLegE = new Random().nextInt(10);
