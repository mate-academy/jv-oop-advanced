...
public class FigureSupplier {
    ...
    public String getRandomFigure() {
        ...
        if (figure.equals("RECTANGLE")) {
            return new Rectangle(colorSupplier.getRandomColor(), getRandomSize(),getRandomSize()).toString();
        } else {
            return new IsoscelesTrapezoid(colorSupplier.getRandomColor(), getRandomSize(),getRandomSize(),
