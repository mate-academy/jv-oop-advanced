...
public class FigureSupplier {
    ...
    public Figure getRandomFigure() {
        ...
        IsoscelesTrapezoid isoscelesTrapezoid = new IsoscelesTrapezoid(a, b, h, randomColor);
        Figure[] figures = new Figure[]{circle, square, rectangle, rightTriangle, isoscelesTrapezoid};
