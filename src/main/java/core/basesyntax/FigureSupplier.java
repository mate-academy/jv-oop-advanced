...
public class FigureSupplier {
    ...
    public Object getRandomFigure() {
        ...
        switch (target) {
            ...
            case 1:
                return new RightTriangle(colorSupplier.getRandomColor(), generatedDouble, generatedDouble);
            case 2:
                return new Rectangle(colorSupplier.getRandomColor(), generatedDouble, generatedDouble);
            case 3:
                return new IsoscelesTrapezoid(colorSupplier.getRandomColor(), generatedDouble, generatedDouble, generatedDouble);
            case 4:
            default:
