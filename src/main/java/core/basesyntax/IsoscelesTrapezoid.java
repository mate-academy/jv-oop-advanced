...
public class IsoscelesTrapezoid extends Figure implements Area {
    ...
    public void setBottom(double bottom) {
        if (bottom > 0) this.bottom = bottom;
        else System.out.println("Dolna długość nie może być mniejsza od 0");
    }
    ...
    public void setTop(double top) {
        ...
        else System.out.println("Górna długość nie może być mniejsza od 0");
    }
    public double getHight() {
        return this.hight;
    }
    public void setHight(double hight) {
        if (hight > 0) this.hight = hight;
        else System.out.println("Wysokość trapezu nie może być mniejsza od 0");
    }
    @Override
